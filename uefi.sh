...
echo root:password | chpasswd #change root password here
...
pacman -S --noconfirm grub efibootmgr networkmanager network-manager-applet dialog wpa_supplicant mtools dosfstools reflector base-devel linux-headers avahi xdg-user-dirs xdg-utils nfs-utils inetutils dnsutils bluez bluez-utils cups hplip alsa-utils pulseaudio bash-completion rsync reflector acpi acpi_call tlp bridge-utils dnsmasq ebtables iptables ipset ufw sof-firmware nss-mdns acpid os-prober ntfs-3g terminus-font
